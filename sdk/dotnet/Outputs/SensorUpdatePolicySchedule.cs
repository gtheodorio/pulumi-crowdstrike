...
namespace CrowdStrike.Crowdstrike.Outputs
{
    ...
    [OutputType]
    public sealed class SensorUpdatePolicySchedule
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.SensorUpdatePolicyScheduleTimeBlock> TimeBlocks;
        /// <summary>
        ...
        [OutputConstructor]
        private SensorUpdatePolicySchedule(
            bool enabled,

            ImmutableArray<Outputs.SensorUpdatePolicyScheduleTimeBlock> timeBlocks,
