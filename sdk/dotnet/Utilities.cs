...
namespace CrowdStrike.Crowdstrike
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("CrowdStrike.Crowdstrike.version.txt");
    ...
    internal sealed class CrowdstrikeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CrowdstrikeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
