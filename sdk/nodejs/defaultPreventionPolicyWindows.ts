 ...
 * ```
 */
export class DefaultPreventionPolicyWindows extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultPreventionPolicyWindowsState, opts?: pulumi.CustomResourceOptions): DefaultPreventionPolicyWindows {
        return new DefaultPreventionPolicyWindows(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'crowdstrike:index/defaultPreventionPolicyWindows:DefaultPreventionPolicyWindows';

    /**
     * Returns true if the given object is an instance of DefaultPreventionPolicyWindows.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultPreventionPolicyWindows {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultPreventionPolicyWindows.__pulumiType;
    }
     ...
     */
    public readonly adwareAndPup!: pulumi.Output<outputs.DefaultPreventionPolicyWindowsAdwareAndPup>;
    /**
     ...
     */
    public readonly cloudAntiMalware!: pulumi.Output<outputs.DefaultPreventionPolicyWindowsCloudAntiMalware>;
    /**
     ...
     */
    public readonly cloudAntiMalwareMicrosoftOfficeFiles!: pulumi.Output<outputs.DefaultPreventionPolicyWindowsCloudAntiMalwareMicrosoftOfficeFiles>;
    /**
     ...
     */
    public readonly cloudAntiMalwareUserInitiated!: pulumi.Output<outputs.DefaultPreventionPolicyWindowsCloudAntiMalwareUserInitiated>;
    /**
     ...
     */
    public readonly extendedUserModeData!: pulumi.Output<outputs.DefaultPreventionPolicyWindowsExtendedUserModeData>;
    /**
     ...
     */
    public readonly sensorAntiMalware!: pulumi.Output<outputs.DefaultPreventionPolicyWindowsSensorAntiMalware>;
    /**
     ...
     */
    public readonly sensorAntiMalwareUserInitiated!: pulumi.Output<outputs.DefaultPreventionPolicyWindowsSensorAntiMalwareUserInitiated>;
    /**
     ...
     */
    constructor(name: string, args: DefaultPreventionPolicyWindowsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultPreventionPolicyWindowsArgs | DefaultPreventionPolicyWindowsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultPreventionPolicyWindowsState | undefined;
            ...
            const args = argsOrState as DefaultPreventionPolicyWindowsArgs | undefined;
        ...
        super(DefaultPreventionPolicyWindows.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DefaultPreventionPolicyWindowsState {
    /**
     * Whether to enable the setting. Allows the sensor to get more data from a user-mode component it loads into all eligible processes, which augments online machine learning and turns on additional detections. Recommend testing with critical applications before full deployment.
     */
     ...
     * Use cloud-based machine learning informed by global analysis of executables to detect and prevent adware and potentially unwanted programs (PUP) for your online hosts.
     */
    adwareAndPup?: pulumi.Input<inputs.DefaultPreventionPolicyWindowsAdwareAndPup>;
    /**
     * Whether to enable the setting. Creation of a process, such as a command prompt, from an exploited browser or browser flash plugin was blocked.
     */
     ...
     * Use cloud-based machine learning informed by global analysis of executables to detect and prevent known malware for your online hosts.
     */
    cloudAntiMalware?: pulumi.Input<inputs.DefaultPreventionPolicyWindowsCloudAntiMalware>;
    /**
     * Identifies potentially malicious macros in Microsoft Office files and, if prevention is enabled, either quarantines the file or removes the malicious macros before releasing the file back to the host
     */
    cloudAntiMalwareMicrosoftOfficeFiles?: pulumi.Input<inputs.DefaultPreventionPolicyWindowsCloudAntiMalwareMicrosoftOfficeFiles>;
    /**
     * For online hosts running on-demand scans initiated by end users, use cloud-based machine learning informed by global analysis of executables to detect and prevent known malware.
     */
    cloudAntiMalwareUserInitiated?: pulumi.Input<inputs.DefaultPreventionPolicyWindowsCloudAntiMalwareUserInitiated>;
    /**
     * Whether to enable the setting. Kill processes that unexpectedly injected code into another process. Requires additional*user*mode_data to be enabled.
     */
     ...
     * Allows the sensor to get more data from a user-mode component it loads into all eligible processes, which augments online machine learning and turns on additional detections. Recommend testing with critical applications before full deployment.
     */
    extendedUserModeData?: pulumi.Input<inputs.DefaultPreventionPolicyWindowsExtendedUserModeData>;
    /**
     * Whether to enable the setting. A process that created a file with a known ransomware extension was terminated.
     */
     ...
     * For offline and online hosts, use sensor-based machine learning to identify and analyze unknown executables as they run to detect and prevent malware.
     */
    sensorAntiMalware?: pulumi.Input<inputs.DefaultPreventionPolicyWindowsSensorAntiMalware>;
    /**
     * For offline and online hosts running on-demand scans initiated by end users, use sensor-based machine learning to identify and analyze unknown executables to detect and prevent malware.
     */
    sensorAntiMalwareUserInitiated?: pulumi.Input<inputs.DefaultPreventionPolicyWindowsSensorAntiMalwareUserInitiated>;
    /**
     * Whether to enable the setting. Blocks attempts to tamper with the sensor. If disabled, the sensor still creates detections for tampering attempts but doesn’t block them. Disabling not recommended.
     */
 ...
 */
export interface DefaultPreventionPolicyWindowsArgs {
    /**
     * Whether to enable the setting. Allows the sensor to get more data from a user-mode component it loads into all eligible processes, which augments online machine learning and turns on additional detections. Recommend testing with critical applications before full deployment.
     */
    additionalUserModeData?: pulumi.Input<boolean>;
