 ...
 * ```
 */
export class DefaultPreventionPolicyMac extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultPreventionPolicyMacState, opts?: pulumi.CustomResourceOptions): DefaultPreventionPolicyMac {
        return new DefaultPreventionPolicyMac(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'crowdstrike:index/defaultPreventionPolicyMac:DefaultPreventionPolicyMac';

    /**
     * Returns true if the given object is an instance of DefaultPreventionPolicyMac.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultPreventionPolicyMac {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultPreventionPolicyMac.__pulumiType;
    }
     ...
     */
    public readonly cloudAdwareAndPup!: pulumi.Output<outputs.DefaultPreventionPolicyMacCloudAdwareAndPup>;
    /**
     ...
     */
    public readonly cloudAntiMalware!: pulumi.Output<outputs.DefaultPreventionPolicyMacCloudAntiMalware>;
    /**
     ...
     */
    public readonly sensorAdwareAndPup!: pulumi.Output<outputs.DefaultPreventionPolicyMacSensorAdwareAndPup>;
    /**
     ...
     */
    public readonly sensorAntiMalware!: pulumi.Output<outputs.DefaultPreventionPolicyMacSensorAntiMalware>;
    /**
     ...
     */
    constructor(name: string, args: DefaultPreventionPolicyMacArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultPreventionPolicyMacArgs | DefaultPreventionPolicyMacState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultPreventionPolicyMacState | undefined;
            ...
            const args = argsOrState as DefaultPreventionPolicyMacArgs | undefined;
        ...
        super(DefaultPreventionPolicyMac.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DefaultPreventionPolicyMacState {
    /**
     * Whether to enable the setting. Execution of a command shell was blocked and is indicative of the system hosting a Chopper web page.
     */
     ...
     * Use cloud-based machine learning informed by global analysis of executables to detect and prevent adware and potentially unwanted programs (PUP) for your online hosts.
     */
    cloudAdwareAndPup?: pulumi.Input<inputs.DefaultPreventionPolicyMacCloudAdwareAndPup>;
    /**
     * Use cloud-based machine learning informed by global analysis of executables to detect and prevent known malware for your online hosts.
     */
    cloudAntiMalware?: pulumi.Input<inputs.DefaultPreventionPolicyMacCloudAntiMalware>;
    /**
     * Whether to enable the setting. Block processes matching hashes that you add to IOC Management with the action set to "Block" or "Block, hide detection".
     */
     ...
     * For offline and online hosts, use sensor-based machine learning to identify and analyze unknown executables as they run to detect and prevent adware and potentially unwanted programs (PUP).
     */
    sensorAdwareAndPup?: pulumi.Input<inputs.DefaultPreventionPolicyMacSensorAdwareAndPup>;
    /**
     * For offline and online hosts, use sensor-based machine learning to identify and analyze unknown executables as they run to detect and prevent malware.
     */
    sensorAntiMalware?: pulumi.Input<inputs.DefaultPreventionPolicyMacSensorAntiMalware>;
    /**
     * Whether to enable the setting. Blocks attempts to tamper with the sensor. If disabled, the sensor still creates detections for tampering attempts but doesn’t block them. Disabling not recommended.
     */
 ...
 */
export interface DefaultPreventionPolicyMacArgs {
    /**
     * Whether to enable the setting. Execution of a command shell was blocked and is indicative of the system hosting a Chopper web page.
     */
    chopperWebshell?: pulumi.Input<boolean>;
