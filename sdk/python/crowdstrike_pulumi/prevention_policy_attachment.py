...
class PreventionPolicyAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] id_property: The prevention policy id you want to attach to.
...
class PreventionPolicyAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            id_property: Optional[pulumi.Input[str]] = None,
            ioa_rule_groups: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            last_updated: Optional[pulumi.Input[str]] = None) -> 'PreventionPolicyAttachment':
        """
