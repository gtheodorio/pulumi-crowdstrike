...
SHELL            := /bin/bash
PROJECT          := github.com/crowdstrike/pulumi-crowdstrike
NODE_MODULE_NAME := @crowdstrike/pulumi
TF_NAME          := crowdstrike
...
TFGEN            := pulumi-tfgen-crowdstrike
PROVIDER         := pulumi-resource-crowdstrike
